...
public class CommandHandler {
    ...
    private static void printOutput(boolean successful, List<Offering> data, String status) {
        JSONObject jsonObject = new JSONObject();
        JSONArray jsonArray = new JSONArray();

        if (successful) {
            for (Offering offering : data) {
    ...
    private static void printOutput(boolean successful, Offering data) {
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("success", successful);
        if (successful)
    ...
    public static void handleAddOffering(String data) throws Exception {
        ...
        printOutput(true, bolbolestan.addOffering(offering));
    }
